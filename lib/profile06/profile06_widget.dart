...
class _Profile06WidgetState extends State<Profile06Widget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<OwnersDetailsRow>>(
      future: OwnersDetailsTable().querySingleRow(
        queryFn: (q) => q,
      ),
      builder: (context, snapshot) {
        ...
        List<OwnersDetailsRow> profile06OwnersDetailsRowList = snapshot.data!;
        final profile06OwnersDetailsRow =
            profile06OwnersDetailsRowList.isNotEmpty
                ? profile06OwnersDetailsRowList.first
                : null;
        return Title(
            title: 'Profile06',
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              FutureBuilder<
                                                  List<OwnersDetailsRow>>(
                                                future: OwnersDetailsTable()
                                                    .querySingleRow(
                                                  queryFn: (q) => q,
                                                ),
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<OwnersDetailsRow>
                                                      textOwnersDetailsRowList =
                                                      snapshot.data!;
                                                  final textOwnersDetailsRow =
                                                      textOwnersDetailsRowList
                                                              .isNotEmpty
                                                          ? textOwnersDetailsRowList
                                                              .first
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset(
                                          'assets/images/WhatsApp_Image_2023-07-09_at_3.09.04_PM.jpeg',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
 ...
 */
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('Ownerdetails');
                            },
                            child: Container(
                              width: double.infinity,
                              height: 60.0,
