...
class _ActivetisWidgetState extends State<ActivetisWidget> {
  late ActivetisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivetisModel());
                            ...
                            children: [
                              ...
                              FutureBuilder<List<BoatsRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<BoatsRow> columnBoatsRowList =
                                      snapshot.data!;
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(columnBoatsRowList.length,
                                            (columnIndex) {
